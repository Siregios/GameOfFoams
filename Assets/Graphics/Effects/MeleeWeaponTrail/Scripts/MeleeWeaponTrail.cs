...
public class MeleeWeaponTrail : MonoBehaviour {
    ...
    void Start() {
        ...
        _trailObject = new GameObject(gameObject.name + " Trail");
        ...
        MeshFilter mf = _trailObject.AddComponent<MeshFilter>();
        MeshRenderer mr = _trailObject.AddComponent<MeshRenderer>();
    ...
    void Update() {
        ...
        if (pointsToUse.Count > 1) {
            ...
            for (int n = 0; n < pointsToUse.Count; ++n) {
                ...
                float size = sizeOverLifetime.Evaluate(time) - 1.0f;
